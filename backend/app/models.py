...
class Build(Base):
    ...
    weapon_skills = Column(String(250), nullable=True)
    ...
    helmet_skills = Column(String(250), nullable=True)
    ...
    chest_skills = Column(String(250), nullable=True)
    ...
    boots_skills = Column(String(250), nullable=True)
...
class PlayerBuildApproval(Base):
    ...
    build_id = Column(Integer, ForeignKey('builds.id'), nullable=False)
    caller = Column(String(30), nullable=True)
...
class ZvZEvent(Base):
    ...
    discord_channel_id = Column(String(64), nullable=True)
    discord_message_id = Column(String(64), nullable=True)
    discord_message_url = Column(String(500), nullable=True)
    discord_message_extra = Column(Text, nullable=True)
    discord_last_sync_at = Column(DateTime, nullable=True)
